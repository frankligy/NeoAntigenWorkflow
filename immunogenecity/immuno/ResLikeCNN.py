...
# please save this model now!!!
    ResLikeCNN.save_weights('ResLikeCNN_epoch8_sigmoid/')

#  scoring section
    peptide_score = ['LPEEKVSTF','IPPSFLQAM','YPFHDIEPSS']
    hla_score = ['HLA-B*3501','HLA-B*3501','HLA-B*3501']
    immuno_score = ['0','0','0']
