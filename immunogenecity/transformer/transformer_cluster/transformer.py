...
if __name__ == '__main__':
    ...
    ori = pd.read_csv('/data/salomonis2/LabFiles/Frank-Li/immunogenecity/data/new_testing_new.txt',sep='\t')
    ...
    max_length = 54
    testing_loader = DataLoader(testing_dataset,batch_size=1360,shuffle=True,drop_last=True)
    model = Encoder(max_length,20,6,1,4,0.1,max_length).to(device)
    model.load_state_dict(torch.load('/data/salomonis2/LabFiles/Frank-Li/immunogenecity/transformer/model/epoch100.pth'))
    ...
    with torch.no_grad():
        for i,(X,y) in enumerate(testing_loader):
            ...
            s = shelve.open('/data/salomonis2/LabFiles/Frank-Li/immunogenecity/transformer/testing/testing1')
    ...
    # ori = pd.read_csv('/data/salomonis2/LabFiles/Frank-Li/immunogenecity/data/data_new.txt',sep='\t')
    # hla = pd.read_csv('/data/salomonis2/LabFiles/Frank-Li/immunogenecity/transformer/hla2paratopeTable.txt',sep='\t',header=None,names=['hla','paratope'])
    # inventory = hla['hla']
    # dic_inventory = dict_inventory(inventory)
    ...
    # torch.save(model.state_dict(),'/data/salomonis2/LabFiles/Frank-Li/immunogenecity/transformer/model/epoch100.pth')
